...
export const cards = [
  { _id: 'task1', list_id: 'list1', index: 1, name: 'Task 1', list_name: 'todo' },
  { _id: 'task2', list_id: 'list1', index: 2, name: 'Task 2', list_name: 'todo' },
  { _id: 'task3', list_id: 'list2', index: 1, name: 'Task 3', list_name: 'doing' },
  { _id: 'task4', list_id: 'list3', index: 1, name: 'Task 4', list_name: 'done' }
]
